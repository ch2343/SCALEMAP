...
for METHOD in "${METHODS[@]}"; do
  ...
  COMBINE_JOBID=$(sbatch \
    ...
    --wrap="cd /nfs/roberts/project/pi_lg689/ch2343/multi-omics/benchmark_script && python -u combine_method_metrics_across_seeds.py ${METHOD} ${VERSION_BASE} ${OUTPUT_ROOT} --seeds 10 25 35 45 42")
