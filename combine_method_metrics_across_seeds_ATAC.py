...
def main():
    ...
    for seed in args.seeds:
        ...
        seed_csv = os.path.join(out_dir, f"summary_{args.method}_{MODALITIES}_{version}.csv")
        df.to_csv(seed_csv)
    ...
    mean_csv = os.path.join(out_dir, f"summary_{args.method}_{MODALITIES}_{args.version_base}_avg_over_seeds.csv")
    sd_csv = os.path.join(out_dir, f"summary_{args.method}_{MODALITIES}_{args.version_base}_sd_over_seeds.csv")
    ...
    long_csv = os.path.join(out_dir, f"summary_{args.method}_{MODALITIES}_{args.version_base}_all_seeds_long.csv")
